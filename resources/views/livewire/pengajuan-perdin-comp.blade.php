<div>
    ...
    <div x-data="{ open: false }" x-on:open-modal.window="open = true" x-on:close-modal.window="open = false"
        ...
        <div x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
            ...
            class="fixed inset-0 opacity-50 bg-black " @click="open = false"></div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden">
            <div x-show="open" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="relative bg-white rounded-lg shadow-sm">
                    ...
                    <div class="p-4 md:p-5 space-y-4" wire:loading.class="opacity-0">
                            ...
                            <div class="bg-gray-200 p-2 flex items-top w-full rounded-b-lg border-1 border-gray-200">
                                ...
                                <div class="w-1/3 text-center">
                                    <div class="flex flex-col">
                                        ...
                                        <p class="text-xs font-light text-gray-500">({{ $dailyAllowanceDesc ?? '' }})
                                        </p>
                                    </div>
                                </div>
                                <div class="w-1/3 text-center">
                    ...
                    <div class="flex justify-center items-center p-4 md:p-5 border-t border-gray-200 rounded-b">
                        ...
                        @else
                            <button wire:click="reject({{ $showId }})" @click="$dispatch('close-modal')"
                                type="button"
                            ...
                            <button wire:click="approve({{ $showId }})" @click="$dispatch('close-modal')"
                                type="button"
